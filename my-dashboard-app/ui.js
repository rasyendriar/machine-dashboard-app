...
export const elements = {
    ...
    migrateBtn: document.getElementById('migrate-images-btn'), // <-- ADD THIS
    migrateBtnText: document.getElementById('migrate-btn-text'), // <-- ADD THIS
    // ... existing elements ...
};
...
/**
 * Generates the HTML for the progress status badge.
 * @param {object} item The purchase item.
 * @returns {string} HTML string for the status badge.
 */
export const getProgressStatusDisplay = (item) => {
...
/**
 * Calculates and updates dashboard metrics and charts.
 * @param {Array} purchases The array of purchase data.
 */
export const updateDashboard = (purchases) => {
    let stats = {
    ...
    elements.keyMetricsContainer.innerHTML = `
...
export const populateProjectFilter = (purchases) => {
...
/**
 * Renders the main data table based on current filters and search term.
 * @param {Array} purchases The array of all purchase data.
 */
export const renderTable = (purchases) => {
    const searchTerm = elements.searchInput.value.toLowerCase();
    const selectedProject = elements.projectFilter.value;
    const filteredData = purchases.filter(p => (p.itemName.toLowerCase().includes(searchTerm) || p.noDrawing.toLowerCase().includes(searchTerm)) && (selectedProject === 'all' || p.projectCode === selectedProject));
...
export const populateFormForEdit = (item) => {
...
export const showDetailsModal = (item) => {
...
export const checkDashboardVisibility = () => {
...
export const setupUIForRole = (role) => {
    if (role === 'admin') {
...
export const setLoginError = (visible) => {
    document.getElementById('login-error').classList.toggle('hidden', !visible);
};
